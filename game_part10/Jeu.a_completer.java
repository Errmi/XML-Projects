...
public abstract class Jeu {
        ...
        do {
            ...
            switch (touche) {
                ...
                case Keyboard.KEY_1: // choisi un niveau et charge un mot depuis le dico
                    ...
                    String motNouveau = dico.getMotDepuisListeNiveaux(niveau);
                    // crée un nouvelle partie
                    partie = new Partie("2018-09-7", motNouveau, niveau); //???
                    
                    // Affiche le mot quelques secondes à l'écran avant la partie (NOT SURE ABOUT THIS!??)
                    menuText.addText("Trouve ce mot : " + motNouveau, "Mot", 200, 300);
                    menuText.getText("Mot").display();
                    //???
                    //Solution 1: Thread.sleep(5000);
                    /*Solution 2:
    ...
    public void joue(Partie partie) {
        ...
        // Ajoute chaque lettre à l'environnement
